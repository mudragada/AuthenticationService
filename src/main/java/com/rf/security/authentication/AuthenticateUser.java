...
public class AuthenticateUser {
	   ...
	   public boolean authenticate(Connection con, String login, String password)
	       ...
	       try {
	           ...
	           ps = con.prepareStatement("SELECT PASSWORD, SALT FROM user_authenticate WHERE LOGIN = ?");
	           ...
	           throws SQLException, NoSuchAlgorithmException, UnsupportedEncodingException
	   {
	       ...
	       try {
	           if (login!=null&&password!=null&&login.length()<=100){
	               ...
	               ps = con.prepareStatement("INSERT INTO user_authenticate (LOGIN, PASSWORD, SALT) VALUES (?,?,?)");
	               ps.setString(1,login);
...
//	 
	   ...
	   public static void main(String[] args) {
		   ...
		   try {
			  ...
			  if (connection == null) {
				  System.out.println("AuthenticateUser::main::Connection is NULL");
			  }
			  else {
			  
//				  System.out.println("AuthenticateUser::main::Inserting test-user1");
//				  authenticateUser.createUser(connection, "test-user1", "password123");
//				  
//				  System.out.println("AuthenticateUser::main::Inserting test-user2");
//				  authenticateUser.createUser(connection, "test-user2", "password1234");
//				  
//				  System.out.println("AuthenticateUser::main::Inserting test-user3");
//				  authenticateUser.createUser(connection, "test-user3", "password12345");
				  
				  System.out.println("AuthenticateUser::main::Authenticating test-user3");
				  boolean isUserValid = authenticateUser.authenticate(connection, "test-user3", "password12345");
				  
				  System.out.println("AuthenticateUser::main::Authenticating test-user3, isUserValid = " + isUserValid);
